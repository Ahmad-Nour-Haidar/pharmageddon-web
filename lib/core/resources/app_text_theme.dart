...
abstract class AppTextStyle {
  ...
  static const f18w600TextColor = TextStyle(
    fontSize: 18,
    color: AppColor.textColor,
  ...
  static const f18w500red = TextStyle(
    fontSize: 18,
    color: AppColor.red,
    fontWeight: FontWeight.w500,
  );

  static const f18w500secondColor = TextStyle(
    fontSize: 18,
  ...
  static const f18w600blue = TextStyle(
    fontSize: 18,
    color: AppColor.blue,
    fontWeight: FontWeight.w600,
  );

  static const f18w500green = TextStyle(
    fontSize: 18,
  ...
  static const f20w400gray = TextStyle(
    fontSize: 20,
    color: AppColor.gray,
    fontWeight: FontWeight.w400,
  );
  ...
  static const f16w600TextColor2 = TextStyle(
    fontSize: 16,
    color: AppColor.textColor,
    fontWeight: FontWeight.w600,
  );
  ...
  static const f16w500black = TextStyle(
    fontSize: 16,
    color: AppColor.black,
    fontWeight: FontWeight.w500,
  );
  ...
  static const f14w500black = TextStyle(
    fontSize: 14,
    color: AppColor.black,
    fontWeight: FontWeight.w500,
  );

  static const f24w600black = TextStyle(
    fontSize: 24,
    color: AppColor.black,
    fontWeight: FontWeight.w600,
  );

  static const f24w600white = TextStyle(
    fontSize: 24,
    color: AppColor.white,
    fontWeight: FontWeight.w600,
    letterSpacing: 1.0,
  ...
  static const f26w600black = TextStyle(
    fontSize: 26,
    color: AppColor.black,
    fontWeight: FontWeight.w600,
  );

  static const f26w600white = TextStyle(
    fontSize: 26,
    color: AppColor.white,
    fontWeight: FontWeight.w600,
  );

  static const f28w700black = TextStyle(
    fontSize: 28,
    color: AppColor.black,
    fontWeight: FontWeight.w700,
  );

  static const f16w400gray2 = TextStyle(
    fontSize: 16,
    color: AppColor.gray2,
    fontWeight: FontWeight.w400,
  );

  static const f15w400black = TextStyle(
    fontSize: 15,
    color: AppColor.black,
    fontWeight: FontWeight.w400,
  );
  ...
  static const f32w600black = TextStyle(
    fontSize: 32.0,
    color: AppColor.black,
    fontWeight: FontWeight.w600,
  );
